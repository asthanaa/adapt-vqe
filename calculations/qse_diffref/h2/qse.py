...
def test():
    ...
    spin = 0
    basis = 'sto3g'
    [n_orb, n_a, n_b, h, g, mol, E_nuc, E_scf, C, S] = pyscf_helper.init(geometry,charge,spin,basis,n_frzn_occ=0,n_act=2)
    ...
    [e,v,params,ansatz_mat] = vqe_methods_edit.adapt_vqe_edit(fermi_ham, pool, reference_ket, theta_thresh=1e-9,det_limit=1)
