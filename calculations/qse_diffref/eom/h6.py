...
def test():
    ...
    [e,v,params,ansatz_mat] = vqe_methods_edit.adapt_vqe_edit(fermi_ham, pool, reference_ket, theta_thresh=1e-9,det_limit=5)
    ...
    print('final excited state energies',(np.sort(eig.real)+e))
