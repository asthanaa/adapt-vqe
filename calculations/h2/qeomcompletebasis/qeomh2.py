...
def test():
    ...
    op=qeom.createops_ipea(n_orb,n_a,n_b,n_orb-n_a,n_orb-n_b,reference_ket)
    #op=qeom.createops_ipcomplete_h2b(n_orb,n_a,n_b,n_orb-n_a,n_orb-n_b,reference_ket)
    #print('op[0] is',op[0])
