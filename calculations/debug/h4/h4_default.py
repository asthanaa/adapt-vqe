...
def test():
    ...
    [e,v,params,ansatz_mat] = vqe_methods.adapt_vqe(fermi_ham, pool, reference_ket, theta_thresh=1e-9, adapt_thresh=1e-9)
    #[e,v,params,ansatz_mat] = vqeorbopt.ooadapt(n_orb,n_a,n_b,n_orb-n_a,n_orb-n_b,fermi_ham, pool, reference_ket, theta_thresh=1e-9)
