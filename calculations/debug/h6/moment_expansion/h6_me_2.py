...
def test():
    ...
    [e,v,n_iter,e_curr_ad,e_curr_me2,e_curr_me3,e_curr_me4] = vqe_methods_edit.adapt_vqe_me(fermi_ham, pool, reference_ket, theta_thresh=1e-9,adapt_thresh=1e-9)
